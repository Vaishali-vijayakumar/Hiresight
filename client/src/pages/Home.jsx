...
const Home = () => {
  return (
    <div className="pt-24 pb-20 min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-center px-6 relative overflow-hidden">
      {/* Background Gradients */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-indigo-500/5 rounded-full blur-[120px] pointer-events-none"></div>
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-pink-500/5 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <motion.h1 
            className="text-4xl md:text-6xl font-black mb-6 tracking-tight font-outfit text-slate-900"
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.1 }}
          >
            Welcome to <span className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">HireSight</span>
          </motion.h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto">
          ...
          {/* HR Admin Card */}
          <motion.div
            className="relative group bg-white border border-slate-200 hover:border-indigo-500 rounded-2xl p-8 lg:p-10 flex flex-col justify-between transition-all duration-300 shadow-sm hover:shadow-md overflow-hidden"
          ...
          >
            ...
            <div>
              ...
              {/* Features List */}
              <ul className="space-y-4 mb-10 text-xs text-slate-700 font-semibold">
                <li className="flex items-center gap-3">
                  <UploadCloud size={16} className="text-indigo-600 shrink-0" />
            ...
            <Link 
              to="/admin" 
              className="w-full py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-center rounded-xl transition-all duration-300 no-underline shadow-sm flex items-center justify-center gap-2"
            >
          ...
          {/* Candidate Card */}
          <motion.div
            className="relative group bg-white border border-slate-200 hover:border-pink-500 rounded-2xl p-8 lg:p-10 flex flex-col justify-between transition-all duration-300 shadow-sm hover:shadow-md overflow-hidden"
            initial={{ opacity: 0, x: 40 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5, delay: 0.3 }}
            whileHover={{ y: -4 }}
          >
            ...
            <Link 
              to="/candidate" 
              className="w-full py-4 bg-pink-600 hover:bg-pink-500 text-white font-bold text-center rounded-xl transition-all duration-300 no-underline shadow-sm flex items-center justify-center gap-2"
            >
